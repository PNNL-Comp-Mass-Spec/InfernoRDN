...
namespace DAnTE.ExtraControls
{
    public partial class ucDataGridView : UserControl
    {
        ...
        public DataTable SetDataSource
        {
            ...
            get => ((DataTable)dAnTEdatagridview1.DataSource);
        }

        public DataGridViewSelectedRowCollection SelectedRows => dAnTEdatagridview1.SelectedRows;
        ...
        public DataGridView TableGrid => dAnTEdatagridview1;
    }
}